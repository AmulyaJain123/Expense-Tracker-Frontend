...
export default function Filter({ data, changeFilter, type }) {
  ...
  return (
    <>
      ...
      {modalOpen ? (
        <div className="fixed flex z-10 scale-75 flex-col space-x-8 top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] bg-white rounded-2xl p-1 pb-1">
          <Tags
