    ...
    try {
      const res = await fetch(
        import.meta.env.VITE_BACKEND_API + "/vault/addtag",
        {
          ...
          body: JSON.stringify({ value: addInput, type: type }),
          credentials: "include",
        }
      );
      setLoading(false);
  ...
  return (
    <>
      <div className="flex w-full flex-col flex-grow bg-inherit rounded-xl">
        ...
        <div className="mx-4 mt-4 max-h-[300px] overflow-auto customScrollThin">
          {fetchedData === null ? (
            <div className="items-center flex-grow h-[200px] flex justify-center">
