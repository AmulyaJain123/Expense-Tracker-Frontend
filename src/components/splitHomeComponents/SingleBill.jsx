...
export default function SingleBill({ data }) {
  ...
  return (
    <div className="px-3 pt-3  flex flex-col space-y-3 flex-grow">
      <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0  justify-between">
        <div className="p-1 px-2 bg-stone-100 h-fit  rounded-md">
      ...
      <div className="flex">
        <div className="p-1 px-2 bg-stone-100 flex-grow sm:flex-row flex-col items-center space-y-2 sm:space-y-0 sm:items-start flex rounded-md">
          <span className="text-black mr-3 text-md text-nowrap font-semibold">
            Description :
          </span>
          <span className="px-2 text-stone-400 text-center sm:text-start min-h-[60px]">
      ...
      <div className="p-1 px-2 bg-stone-100 h-fit  rounded-md">
        <div className="flex flex-col text-left space-y-1">
          ...
          <div className="p-5 pt-2 px-4 sm:px-12 h-[180px] overflow-auto text-stone-400 customScrollThin">
            {shares.map((share) => {
              return (
