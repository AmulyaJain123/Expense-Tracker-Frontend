...
import EditInOut from "../components/transactionCreateComponents/EditInOut";
...
export default function EditTransaction() {
  ...
  const [type, setType] = useState(
    data.transaction.category[0] === "incoming" ? 1 : 0
  );
  ...
  return (
    <>
      <Helmet>
        <title>
          {data.transaction.transactionName} | Edit Transaction | BILLBUD
        </title>
