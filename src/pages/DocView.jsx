...
import recIcon from "../assets/doc.png";
...
import Doc from "../components/vaultViewComponents/Doc";
...
export default function DocView() {
  ...
  async function deleteConfirmed() {
    ...
    try {
      const res = await fetch(
        import.meta.env.VITE_BACKEND_API + "/vault/deletedoc",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      <Helmet>
        <title> {data.details.docName} | Doc | BILLBUD</title>
            ...
            {modalOpen === 1 ? (
              <div className="rounded-xl sm:w-[500px] bg-stone-100">
                <h1 className="p-8 pb-4 text-center text-lg sm:text-xl font-medium">
                  Are you sure you want to delete the following Doc?
                </h1>
                  ...
                  <div className="h-[210px] overflow-hidden mb-4">
                    <div className="flex scale-75 origin-top shadow-xl duration-500 flex-col rounded-xl bg-slate-100 ">
                      <div className="p-4  flex space-x-4 ">
                        <div className="p-3 rounded-2xl flex items-center bg-slate-200">
                          <img
                            src={recIcon}
                        ...
                        <div className="flex flex-col w-[150px] justify-center space-y-2">
                          <div className="flex flex-col">
                            ...
                            <span className="pl-1">
                              <OnlyXChars x={15} text={data.details.docName} />
                            </span>
                          </div>
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="pl-1">
                              <OnlyXChars x={20} text={data.details.docDate} />
                            </span>
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col p-4 pt-0 space-y-2">
                        <div className="flex space-x-4 ">
                          ...
                          <span className="pl-1">
                            <OnlyXChars x={20} text={data.details.docDesc} />
                          </span>
                        </div>
                      </div>
                    </div>
      ...
      <div className="h-full w-full billViewBg overflow-auto pb-[200px] text-stone-700 rounded-l-xl">
        <div className="flex flex-col max-w-[1200px] mx-auto">
          ...
          <div className="mx-[10px] px-16  scale-[90%] sm:scale-100 sm:mx-[50px] flex flex-col sm:flex-row justify-between items-center mt-[80px]">
            <Link to={"/vault/protected/view/doc"}>
