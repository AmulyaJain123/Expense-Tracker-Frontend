...
import SortedDocs from "../components/vaultViewComponents/SortedDocs";
import SortDoc from "../components/vaultViewComponents/SortDoc";

export default function VaultDocView() {
  const data = useLoaderData();
  const [filteredData, setFilteredData] = useState(data);
  const sorting = useSelector((state) => state.vault.docSorting);
  const filter = useSelector((state) => state.vault.docFilter);
  ...
  function changeSorting(sortby, order) {
    dispatch(vaultActions.setDocSorting([sortby, order]));
  }

  function changeFiltering(filter) {
    dispatch(vaultActions.setDocFilter(filter));
  }
  ...
  function removeFilter() {
    dispatch(vaultActions.setDocFilter(null));
  }

  function removeSort() {
    dispatch(vaultActions.setDocSorting(null));
  }

  return (
    <>
      <Helmet>
        <title> Saved Docs | BILLBUD</title>
